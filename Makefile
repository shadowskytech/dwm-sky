...
DATA_DIR  := ${USER_HOME}/.local/share/dwm-sky
...
install: all
	...
	mkdir -p ${CFG_DIR}/dwm-sky
	test -f ${CFG_DIR}/dwm-sky/hotkeys.toml || install -Dm644 config/hotkeys.toml ${CFG_DIR}/dwm-sky/hotkeys.toml
	test -f ${CFG_DIR}/dwm-sky/themes.toml  || install -Dm644 config/themes.toml  ${CFG_DIR}/dwm-sky/themes.toml
	test -f ${CFG_DIR}/dwm-sky/window-rules.toml || install -Dm644 config/window-rules.toml ${CFG_DIR}/dwm-sky/window-rules.toml
